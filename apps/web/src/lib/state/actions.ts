...
export const getTokenPrice = async (token:string):Promise<Record<string, any>> => {
...
export const getSolanaTransaction = async (signature:string):Promise<EnrichedTransaction> => {
...
export const getSolanaTransactions = async (address:string):Promise<EnrichedTransaction[]> => {
