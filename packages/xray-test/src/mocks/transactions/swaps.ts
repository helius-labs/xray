export const swapUsdcSol = {
    description:
        "MatrfYnDmsBrdnETpW2S6uksrChkGwyN4RRCXtTPZsv swapped 1485.000 USDC for 61.027185382 SOL",
    type: "SWAP",
    source: "JUPITER",
    fee: 5000,
    feePayer: "MatrfYnDmsBrdnETpW2S6uksrChkGwyN4RRCXtTPZsv",
    signature:
        "3gf6XH8mEDRxLvs6UXEkuUJbKoc2JNDixzQSkTiLc6yYhBmUUpABpRhpuAVBE6jEefQG4p9sf3iTdLa4Azkie4Gw",
    slot: 175188614,
    ...
    instructions: [
        {
            ...
            innerInstructions: [
                ...
                {
                    accounts: ["AjSXQTbiYDz858cfjyWGK2mZBy93b5nkCX2wBCVu2Ae5"],
                    data: "P",
                    programId: "TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA",
                },
                {
